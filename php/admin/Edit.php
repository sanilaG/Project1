...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $stmt->bind_param("sssssssssi", $Blood, $First_Name, $Middle_Name, $Last_Name, $Phone, $Address, $Email, $Dob, $Gender, $id);
  $stmt->execute();
...
<body>
  ...
  ?>
      ...
      <div class="question">
        ...
        <input type="text" id="address" name="Address" placeholder="Enter your current address" value="<?php echo $Address; ?>" required>
      </div>
